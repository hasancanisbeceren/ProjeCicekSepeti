...
public class Senaryo7_EkstraÜrünEkleTest extends BaseTest{
    ...
    public void addExtraProduct(){
        ...
        steps.clickElement("#productDetailSend > div > div > div:nth-child(2) > div.product__main-info-right.js-set-date-base-campaing-class > div.js-advertisement-available > div.product__dates > div:nth-child(2) > div.product__date-item-special-hour.js-date-item-special-time > select.select-green.product__special-time-select.js-special-time-hour");
        steps.clickElement("#productDetailSend > div > div > div:nth-child(2) > div.product__main-info-right.js-set-date-base-campaing-class > div.js-advertisement-available > div.product__dates > div:nth-child(2) > div.product__date-item-special-hour.js-date-item-special-time > select.select-green.product__special-time-select.js-special-time-hour > option:nth-child(2)");
        steps.clickElement("#productDetailSend > div > div > div:nth-child(2) > div.product__main-info-right.js-set-date-base-campaing-class > div.js-advertisement-available > div.product__dates > div:nth-child(2) > div.product__date-item-special-hour.js-date-item-special-time > select.select-green.product__special-time-select.js-special-time-minute");
        steps.clickElement("#productDetailSend > div > div > div:nth-child(2) > div.product__main-info-right.js-set-date-base-campaing-class > div.js-advertisement-available > div.product__dates > div:nth-child(2) > div.product__date-item-special-hour.js-date-item-special-time > select.select-green.product__special-time-select.js-special-time-minute > option:nth-child(2)");
        ...
        steps.sendKeysToElementTest("input[id='GroupDeliveryAddressList_0__Address_AddressName']","Hasancan İSBECEREN");
        steps.keysEnterToElementTest("input[id='GroupDeliveryAddressList_0__Address_Phone_Phone']","5555555555");
        steps.keysEnterToElementTest("textarea[id='GroupDeliveryAddressList_0__Address_AddressLine']","Akasya avm");
        steps.waitSecond(1);
